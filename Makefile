...
BUF_VERSION           := v1.66.0
PROTO_FILES := api/cluster.proto \
	internal/proto/snapshot/v1/snapshot.proto
PROTO_GEN_FILES := api/v1alpha1/server/pb/cluster.pb.go \
	api/v1alpha1/server/pb/cluster_grpc.pb.go \
	internal/proto/snapshot/v1/snapshot.pb.go
...
$(PROTO_GEN_FILES) &: $(PROTO_FILES) buf.yaml buf.gen.yaml buf.gen.grpc.yaml
