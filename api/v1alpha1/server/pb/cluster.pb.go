...
//
// Derived from:
// https://github.com/siderolabs/discovery-api/blob/main/api/v1alpha1/server/cluster.proto
//
...
const file_cluster_proto_rawDesc = "" +
	"\n" +
	"\rcluster.proto\x12\x17sidero.discovery.server\x1a\x1egoogle/protobuf/duration.proto\"M\n" +
	"\tAffiliate\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x12\x1c\n" +
	"\tendpoints\x18\x03 \x03(\fR\tendpoints\"T\n" +
	"\fHelloRequest\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12%\n" +
	"\x0eclient_version\x18\x02 \x01(\tR\rclientVersion\"-\n" +
	"\x0fRedirectMessage\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\"\x84\x01\n" +
	"\rHelloResponse\x12I\n" +
	"\bredirect\x18\x01 \x01(\v2(.sidero.discovery.server.RedirectMessageH\x00R\bredirect\x88\x01\x01\x12\x1b\n" +
	"\tclient_ip\x18\x02 \x01(\fR\bclientIpB\v\n" +
	"\t_redirect\"\xf7\x01\n" +
	"\x16AffiliateUpdateRequest\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12!\n" +
	"\faffiliate_id\x18\x02 \x01(\tR\vaffiliateId\x12*\n" +
	"\x0eaffiliate_data\x18\x03 \x01(\fH\x00R\raffiliateData\x88\x01\x01\x12/\n" +
	"\x13affiliate_endpoints\x18\x04 \x03(\fR\x12affiliateEndpoints\x12+\n" +
	"\x03ttl\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x03ttlB\x11\n" +
	"\x0f_affiliate_data\"\x19\n" +
	...
	"\x05Watch\x12%.sidero.discovery.server.WatchRequest\x1a&.sidero.discovery.server.WatchResponse0\x01B=Z;github.com/grepplabs/talos-discovery/api/v1alpha1/server/pbb\x06proto3"
...
func file_cluster_proto_init() {
	...
	file_cluster_proto_msgTypes[3].OneofWrappers = []any{}
	file_cluster_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
